...
- [x] SVD/spectral-gap prediction of per-head resonant states vs. observed convergence (`spectral_resonance.ipynb`, executed 2026-07-25; not supported as registered, and rescored 2026-07-31 against the loop's true target, the dominant eigenvector of W_OV transposed; FINDINGS.md §3, H4)
