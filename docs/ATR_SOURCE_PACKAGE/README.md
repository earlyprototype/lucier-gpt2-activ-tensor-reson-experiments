...
The process outlined in this repo, and its supporting Jupyter notebooks, proceeds by iterative forward-pass feedback — inputting a prompt then extracting the model's _activation tensor_ (the mathematical representation of the model's state at its final layer, immediately prior to encoding the output back as natural language) and injecting this raw numerical data directly back into the model's input layer, bypassing the normal text interface entirely. This is repeated 500 times. As the semantic content of the initial prompt dissolves, dominant attractor states emerge (stable token configurations the model settles into), revealing the architecture's naked inner voice. See [TECHNICAL.md](docs/TECHNICAL.md) for the formal specification, or [UNDERSTANDING.md](docs/UNDERSTANDING.md) for an accessible explanation of the mechanism.
...
![3D PCA trajectory of semantic dissolution](009a_exploratory/images/topology.png)
...
![Sentence dissolution — the five prompts dissolving into their attractors](009a_exploratory/images/dissolution1.png)

![Dissolution continued](009a_exploratory/images/dissolution2.png)

![Dissolution — the Imperative prompt](009a_exploratory/images/dissolution3.png)
...
![The topological fold — 3D PCA trajectory of semantic dissolution](009a_exploratory/images/topology.png)

### The Visualisations

![Token drift across all five prompts](009a_exploratory/images/tokendrift.png)

![Convergence curves — cosine similarity between iterations](009a_exploratory/images/convergence.png)

![Position collapse — all token positions merging into one](009a_exploratory/images/positioncollapse.png)

![Norm trajectory — the energy of the signal](009a_exploratory/images/normaltrajectory.png)

![Cross-prompt convergence matrix — cosine similarity of final states](009a_exploratory/images/crosspromptconverg.png)
