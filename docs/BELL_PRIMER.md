...
**Lens share 0.145 against 0.25 chance** says the motion also lies outside the subspace the model uses for expressible content generally: closer to internal bookkeeping (frequency, scale) than to meaning.
