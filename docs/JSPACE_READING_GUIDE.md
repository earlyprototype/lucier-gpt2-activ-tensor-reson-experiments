...
**Suggested passes:**
- **Pass 1 (about an hour):** pages 3-13, then 15-18. Stop and self-test: can you state what J_ℓ is an average of, and why the averaging makes a readout "verbalizable"? That is the crux of the whole paper.
